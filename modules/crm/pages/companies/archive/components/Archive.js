...
import {
    companyArchivedRequest,
    companyRestoreRequest,
...
class Archive extends Component {
    ...
    UNSAFE_componentWillMount() {
        ...
        dispatch(companyArchivedRequest({}));
    }

    pageChange(pageNumber = 1) {
        const form = Object.assign({}, { ...this.state.filter, pageNumber });
        this.props.dispatch(companyArchivedRequest(form));
        this.setState({ showFilter: false });
    }

    handleRestore(id) {
        this.props.dispatch(companyRestoreRequest(id));
    }
